			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls form-group">
										<input class="billing-address-name form-control" type="text" name="name" placeholder="Điền tên" required="">
									</div>
									<div class="agileits_card_number_grids">
										<div class="agileits_card_number_grid_left form-group">
											<div class="controls">
												<input type="text" class="form-control" placeholder="Số phone" name="phone" required="">
											</div>
										</div>
										<div class="agileits_card_number_grid_right form-group">
											<div class="controls">
									...
									<div class="controls form-group">
										<select class="option" name="giaohang">
